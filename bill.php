    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="text-center">Bill Generation</h3>
            </div>
                    ...
                    <?php
						...
						while ($row = mysqli_fetch_array($result)){
							...
							<?php 
								...
								$account_ = $_SESSION['pat_account'];
								$status = "Pending";
								$sql = "Insert into bill_master (User_ID,Amount,Status,Account) values('$u_id','$amount','$status','$account_');";
								...
								elseif (isset($_POST['publish'])) {
									...
									while ($row = mysqli_fetch_array($result)){
											$_SESSION['pat_user_id'] = $username;
											$_SESSION['pat_account']=$row['Account'];
											$name1=$row['Name'];
											$email1=$row['Email'];
											$phone1=$row['Phone'];
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="registerForm" class="form-horizontal"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="b_hash">Amount:</label>
                            <div class="col-sm-8"> 
                                <input type="text" class="form-control" id="Amount" placeholder=" Amount in Ethers" name = "Amount"  required>
                            </div>
                        </div>
